  ...
  const doc = React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(View, { style: { marginBottom: 32 } },
        React.createElement(Text, { style: styles.coverTitle }, "NemulAI Carbon Report"),
      ...
      React.createElement(View, { style: styles.section },
        ...
        React.createElement(View, { style: { ...styles.row, marginTop: 6 } },
          React.createElement(Text, { style: { color: "#777" } },
            "Energy measured by NemulAI GPU agent (NVML). Carbon intensity sourced from " +
      ...
      React.createElement(
        Text,
        { style: styles.footer },
        "Generated by NemulAI · GHG Protocol Scope 2 (location-based) · EU AI Act ready · SB 253 aligned · SEC Scope 1/2"
      )
    )
  );
  ...
  if (format === "csv") {
    ...
    return new NextResponse(csv, {
      headers: {
        ...
        "Content-Disposition": `attachment; filename="nemulai-carbon-${slug}.csv"`,
      },
    });
  }
  ...
  if (format === "json") {
    ...
    return new NextResponse(JSON.stringify(json, null, 2), {
      headers: {
        ...
        "Content-Disposition": `attachment; filename="nemulai-carbon-${slug}.json"`,
      },
    });
  }
  ...
  try {
    ...
    return new NextResponse(pdfBuffer, {
      headers: {
        ...
        "Content-Disposition": `attachment; filename="nemulai-carbon-${slug}.pdf"`,
      },
    });
  } catch (err) {
